...
4. **Upcoming**에서 날짜 없이 조회한 뒤 시작일·종료일을 지정해 조회합니다. **Todo**에서 현재 수강 중인 모든 과목의 미제출·마감 없음·지난 과제가 표시되고 제출 완료 과제는 제외되는지 LMS와 비교합니다. 마감 빠른 순 버튼과 LMS 순서 복귀를 확인하며 숨김/완료 버튼은 없어야 합니다.
