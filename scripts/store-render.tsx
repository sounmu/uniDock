...
const header = <><header><span className="mark">u</span><div><h1>uniDock</h1><p>고려대학교 LMS</p></div><span className="badge">읽기 전용</span></header><section className="intro"><span className="eyebrow">MY CAMPUS</span><h2>오늘의 배움,<br/>한곳에서.</h2><p>비공식 학습 도우미 · 샘플 데이터</p></section></>;
...
fs.writeFileSync('store/assets/promo.html','<!doctype html><meta charset="utf-8"><style>body{margin:0;width:880px;height:560px;background:#872038;display:grid;place-items:center}.u{width:160px;height:170px;border:36px solid white;border-top:0;border-radius:0 0 115px 115px;position:relative}.u:before,.u:after{content:"";position:absolute;top:0;width:36px;height:60px;background:#e8b7c2;border-radius:18px}.u:before{left:-36px}.u:after{right:-36px}</style><div class="u"></div>');
